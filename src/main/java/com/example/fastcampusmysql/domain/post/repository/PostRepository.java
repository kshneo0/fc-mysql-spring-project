...
public class PostRepository {
    ...
    public PageImpl<Post> findAllByMemberId(Long memberId, Pageable pageable) {
    ...
    public List<Post> findAllByInMemberIdAndAndOrderByIdDesc(List<Long> memberIds, int size) {
